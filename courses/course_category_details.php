...
<body>
            ...
            <div class="top-title">
                <div class="div-in">
                    <ul>
                        ...
                        <a id="page_link" href="#">
                            <li title="Courses">Courses <i class="bi-caret-right-fill"></i></li>
                        </a>
    ...
    <section class="others-pg-content-div">
                        ...
                        <div class="page-list-back-div">
                            <div class="main-picture-back-div">
                                <div class="main-picture-div preview-image" id="page_preview">
                                    <img id="main_page_preview" src="<?php echo $website_url ?>/api/uploaded-files/dev/blog-pix/default1.jpg" alt="Course" />
                                </div>
                                ...
                                <div class="bottom-img-div">
                                    ...
                                    <div class="inner-img-container">
                                        <div class="inner-img-div" id="fetchPageContentPictures">
                                            <script>
                                                 _fetchEachPageContentPictures('<?php  echo $publish_id ?>', 'courses/fetch-pages-pictures');
                                            </script>
                                        </div>
                                    </div>
                    ...
                    <div class="right-div sticky-div">
                        <div class="div-in">
                            ...
                            <div class="related-post-back-div" id="fetchRelatedPages">
                                <script>
                                    _fetchRelatedPages('courses/fetch-related-courses');
                                </script>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            _fetchEachPageContent('<?php echo $publish_id ?>', 'courses/fetch-each-course', 'courses');
        </script>

...
if ($apiKey!=$expected_api_key){
	...
	$select="SELECT 
		a.publish_id, a.reg_title, a.reg_pix, a.updated_time, a.page_view, b.seo_description, b.page_url, c.cat_name
		FROM publish_tab a, pages_tab b, setup_categories_tab c
		WHERE a.page_category_id='blog_category' 
		AND a.status_id=1 
		AND a.publish_id=b.publish_id AND a.blog_cat_id=c.cat_id

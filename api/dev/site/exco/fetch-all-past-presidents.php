...
if ($apiKey!=$expected_api_key){
	...
	$current_academics_session= $array[0]['current_academics_session'];
		...
		WHERE a.post_id=b.post_id AND a.status_id=c.status_id AND a.level_id=d.level_id AND a.post_id='P' AND a.academics_session !='$current_academics_session' ORDER BY a.academics_session DESC";

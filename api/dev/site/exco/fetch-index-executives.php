...
if ($apiKey!=$expected_api_key){
	...
	goto end;
		...
		WHERE a.post_id=b.post_id AND a.status_id=c.status_id 
		AND a.level_id=d.level_id AND a.post_id IN('P','STD','GS') AND a.status_id=1 AND a.academics_session='$current_academics_session' LIMIT 3";

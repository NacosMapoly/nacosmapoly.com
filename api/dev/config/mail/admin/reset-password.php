...
$message = '
    <div style="width:90%; margin:auto; height:auto;">
        ...
        <div style="padding:15px; font-size:14px; color:#444;">
            ...
            <p>
                ...
                Kindly, click to Reset Password below to complete your reset password process.<br><br>
            ...
            <p><strong>Nacos Mapoly</strong> is the official body for all computing and IT students in Nigeria, fostering innovation, collaboration, and professional development.<br/><br/> 
        ...
        <div style="min-height:30px;background:#333;text-align:left;color:#FFF;line-height:20px;padding:20px 10px 20px 50px;">
            &copy; All Right Reserve.<br>' . $thename . '.<br>' . $currentDate . '
        </div>
    </div>';
    ...
    /// copy this emails
    $mail->addAddress($email, $reciever_name);  // Recipient email and name
    $mail->addAddress($support_email, $sender_name);  // Support email
    $mail->addAddress("afolabiabayomi83@gmail.com", $sender_name);  // Additional recipient

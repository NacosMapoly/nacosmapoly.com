...
<body>
            ...
            <div class="top-title">
                <div class="div-in">
                    <ul>
                        ...
                        <a id="page_link" href="#">
                            <li title="Blog">Blog <i class="bi-caret-right-fill"></i></li>
                        </a>
    ...
    <section class="others-pg-content-div">
                                ...
                                <div class="bottom-img-div">
                                    ...
                                    <div class="inner-img-container">
                                        <div class="inner-img-div" id="fetchPageContentPictures">
                                            <script>
                                                 _fetchEachPageContentPictures('<?php  echo $publish_id ?>', 'blog/fetch-pages-pictures');
                                            </script>
                                        </div>
                                    </div>
                    ...
                    <div class="right-div sticky-div">
                        <div class="div-in">
                            ...
                            <div class="related-post-back-div" id="fetchRelatedPages">
                                <script>
                                    _fetchRelatedPages('blog/fetch-index-blog');
                                </script>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            _fetchEachPageContent('<?php echo $publish_id ?>', 'blog/fetch-each-blog', 'blog');
        </script>
